...
## Bagan Projek
Bagan [Eksekusi](https://chetabahana.github.io/#chetabahana-eksekusi) dari Projek ini secara garis besar dapar digambarkan sesuai diagran berikut dibawah ini. Statusnya bisa anda ikuti via klik item pada bagian [Skema](https://chetabahana.github.io/#chetabahana-skema). Untuk penjelasan serta detilnya bisa Anda simak di [Dokumentasi](https://github.com/MarketLeader/marketleader.github.io/wiki).
...
## Bagan Proses
Setiap komponen dari Bagan Utama akan dikembangkan menjadi **[Bagan Proses](https://github.com/chetabahana/chetabahana.github.io/wiki/Grammar)**, suatu bagan berupa susunan kaidah ([*grammar*](http://en.wikipedia.org/wiki/Grammar)) yang dilakukan sebagai salah satu step dalam [proses penelusuran](https://github.com/chetabahana/chetabahana.github.io/wiki/Tipe-Diagram). Bagan ini diadaptasi dari salah satu pojek di GitHub dengan nama [*railroad-diagrams*](https://github.com/tabatkins/railroad-diagrams). Contoh dari bagan ini dapat dilihat di gambar berikut:
...
SALAM Sukses!  
©️ [**Chetabahana Project**](https://github.com/MarketLeader)  
